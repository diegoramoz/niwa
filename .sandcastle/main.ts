...
// Simple loop: an agent that picks open local issues one by one and closes them.
// Run this with: bun run .sandcastle/main.ts
// Or add to package.json scripts: "sandcastle": "bun run .sandcastle/main.ts"
